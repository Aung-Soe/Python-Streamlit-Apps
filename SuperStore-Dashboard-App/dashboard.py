...
if fl is not None:
    ...
    os.chdir(r"/Users/aungsoe/PycharmProjects/SuperStore-Dashboard")
...
data1 = px.scatter(filtered_df, x="Sales", y="Profit", size="Quantity", template='gridon')
...
with st.expander("View Data"):
    st.write(filtered_df.iloc[:500, 1:20].style.background_gradient(cmap="Blues"))
